...
public class CreateSpatialIndexChange extends AbstractChange
    ...
    public SqlStatement[] generateStatements(final Database database) {
        ...
        BigDecimal minx = new BigDecimal(minX != null ? minX : "30000");
        BigDecimal maxx = new BigDecimal(maxX != null ? maxX : "80000");
        BigDecimal miny = new BigDecimal(minY != null ? minY : "10000");
        BigDecimal maxy = new BigDecimal(maxY != null ? maxY : "30000");

        BigDecimal minz = (minZ != null) ? new BigDecimal(minZ) : null;
        BigDecimal maxz = (maxZ != null) ? new BigDecimal(maxZ) : null;

        BigDecimal tole = new BigDecimal(tolerance != null ? tolerance : "0.01");
        ...
        final CreateSpatialIndexStatement statement = new CreateSpatialIndexStatement(
                ...
                getTablespace(), getGeometryType(), srid, minx, maxx, miny, maxy, minz, maxz, tole);
